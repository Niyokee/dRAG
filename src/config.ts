...
export const config = {
  ...
  ollama: {
    host: validateServiceUrl(process.env.OLLAMA_HOST ?? "http://localhost:11434", "OLLAMA_HOST"),
  ...
  chroma: {
    host: validateServiceUrl(process.env.CHROMA_HOST ?? "http://localhost:8000", "CHROMA_HOST"),
